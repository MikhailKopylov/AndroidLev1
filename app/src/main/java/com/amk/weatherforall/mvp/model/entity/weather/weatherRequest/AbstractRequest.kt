package com.amk.weatherforall.mvp.model.entity.weather.weatherRequest
...
abstract class AbstractRequest {
    ...
    private lateinit var weatherResult: WeatherForecast /*= WeatherForecast(city, arrayOf(weatherDataDefault))
        get() {
